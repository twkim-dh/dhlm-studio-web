...
On April 22, 2026, Tesla reported first-quarter results. Revenue hit $22.4 billion, up 16 percent year over year. Free cash flow came in at $1.4 billion, a $3 billion swing from Wall Street's expected negative figure. Gross margin climbed to 21.1 percent. The automotive gross margin (ex-credits) rebounded to 19.2 percent. Energy storage margins hit a record 39.5 percent. The stock rose 4 percent after hours â and then fell 3.6 percent the next day as the market digested the $25 billion 2026 capex guidance.
...
## Method 1: DCF â What Is Tesla Worth as a Pure Cash-Flow Business?
...
For Tesla, that is a loaded question. Tesla reported $94.83 billion in revenue in full-year 2025, down 2.9 percent year over year. Net income for the full year was $3.79 billion. Operating margin sits at a trailing 5.7 percent â well below the 2022 peak of 17 percent.
...
### Tesla Base-Case DCF (2026â2030)
...
| Year | Revenue | Growth | Op Margin | EBIT | Tax (21%) | NOPAT | + D&A | â CapEx | â ÎWC | **FCF** |
|---|---|---|---|---|---|---|---|---|---|---|
...
Two things deserve immediate attention. First, free cash flow is deeply negative for the next two years under this scenario â and Tesla management has already guided the market to expect negative FCF for the remainder of 2026 as it funds Cybercab capacity, Optimus production lines, and AI infrastructure. A $15 billion net capex-driven cash burn in the full year is consistent with $25 billion of capex running against current operating cash generation of roughly $10â12 billion annually. Second, the entire valuation leans on years 4 and 5 â when the factories built today are supposed to start producing cash.
...
Tesla closed April 23 at $373.60. This DCF â using genuinely bullish operating assumptions about margin expansion and revenue growth â produces a fair value of **$92**. The current stock trades at roughly 4.1x what these cash flows independently justify.
...
**Tesla DCF fair value per share â sensitivity**
...
Across the plausible range â WACC 8 percent to 12 percent, terminal growth 2 percent to 4 percent â the DCF value runs from $38 to $204 per share. The midpoint sits around $85. The stock trades at $373.60.
...
## Method 2: Comparable Companies â What Are Peers Paying for Right Now?
...
The immediate problem with Tesla comps is that Tesla does not have clean peers. Auto OEMs (Ford, GM, Toyota, Volkswagen) trade at 5â8x earnings â Tesla trades at 341x. AI hardware companies (NVIDIA) trade on completely different economics. Tech hyperscalers (MSFT, GOOGL) are dramatically more profitable.
...
| Tesla â AI platform | 16% | 5.7% | 14.2x |
...
This is where the comparison gets sharpest. Tesla has Mag 7 membership in the market's mind â investors treat it as a tech franchise â but its operating margins (5.7 percent) are a fraction of the Mag 7 median (36 percent), and its P/E is 11x the group's median. Applying the Mag 7 median P/E of 30x to Tesla's trailing EPS of $1.09 produces a stock price of about **$33**. Applying the Mag 7 median EV/Revenue of 8.8x produces an enterprise value of roughly **$835 billion**, or about $220 per share.
...
| Large-cap auto M&A | Various | 2015â2024 | $10â30B typical | 0.5â1.5x | Mature auto industry |

The data is clear. Strategic buyers in the auto industry pay 0.5x to 1.5x revenue. IPO buyers at growth peaks paid 100x revenue for EV startups in 2020â2021 â and nearly all of those names subsequently collapsed 80 percent or more.

There is no realistic scenario in which a strategic acquirer pays Tesla's current $1.40 trillion valuation. An acquirer at 5x revenue â already generous for any deal in history â would value Tesla's equity at roughly **$475 billion**, or about $127 per share. An acquirer at 10x revenue would value it at roughly **$950 billion**, or $253 per share.
...
Blended Fair Value Range        âââââââââ $85 â $220 âââââââââ
```
...
The most generous reading â taking the upper bound of each method â produces a fair value range of about $204 to $255. The midpoint consensus across all three sits around $150. The current price implies Tesla trades at roughly 2.5x the midpoint and 1.5x the most optimistic upper bound.

### What Does This Actually Mean?

It does not mean Tesla is going to $150. Stocks trade above conventional fair value for years, sometimes decades â especially when the underlying business is undergoing a category shift the market is trying to price ahead of the fundamentals. Momentum, narrative, scarcity of high-conviction growth names, and index inclusion can sustain a premium indefinitely.

What it does mean is concrete:

1. **Forward returns are structurally compressed.** A stock trading at 2xâ3x its blended fair value cannot produce strong returns over long horizons unless the underlying business grows into the price. For Tesla to be "fairly valued" at today's level in five years, earnings would need to grow roughly 5â7x between now and 2031.
2. **The thesis is entirely about the future.** You are not buying the Tesla of April 2026. You are buying a specific belief about the Tesla of 2030â2035 â a robotaxi fleet generating software-like margins, Optimus at scale, FSD monetized across tens of millions of vehicles, a dominant position in stationary energy storage. The current financials do not support the price. The future ones have to.
...
That does not mean the narrative is wrong. It means the standard valuation tools cannot verify it independently. Investors who can underwrite Tesla's Physical AI platform thesis â with specific, measurable metrics (Robotaxi paid miles economics, Optimus unit shipments, FSD penetration rate, energy storage GWh deployed) â can rationally own the stock at this level. Investors who cannot articulate those specific measurable milestones are not investing. They are momentum-following with extra steps.

The three-method approach does not tell you what Tesla will do. It tells you what Tesla already is today: a stock trading on future assumptions far beyond what any backward-looking method can justify. Knowing that explicitly is worth more than any single price target. It tells you what kind of bet you are making â and what kind of bet you are not.
...
Investor A runs only DCF. They conclude Tesla is deeply overvalued at $373.60 and avoid the stock. Eighteen months later Tesla is at $450. The DCF did not fail â the stock simply kept running on narrative, and Investor A stayed out of a position that was never justified on cash-flow math in the first place. No loss, but a significant opportunity cost.
...
- **TSLA Deep Dive Rev.2 (BEAF 58/C+)** â the full triangulation with updated assumptions from Q1 2026. Our scoring reflects a thesis that is *viable but not compelling at the current price*. The DCF, comp, and narrative sections in that report apply the exact method built here.
- **Physical AI Sector Report** â the narrative variables (Robotaxi, Optimus, FSD) that drive Tesla's gap between fair value and market price are dissected in sector-level detail, including competitive positioning against Waymo, Chinese AV programs, and humanoid robotics peers.
- **NVDA Deep Dive (BEAF 83/B+)** â the cleaner case where DCF and comps actually converge on a high-margin compounder rather than diverging wildly. Useful as a contrast to Tesla's wide-range valuation.
- **Anthropic Private Investor Report** â reference for how pre-revenue AI franchises are priced when traditional methods cannot yet apply.
...
Next week we dismantle DCF further. Not to abandon it â DCF remains one of the most important thinking tools any investor can own â but to examine specifically why small changes in assumptions produce such wide ranges, and what to do about that. We rebuild the model with NVIDIA, where the cash-flow numbers are cleaner and the narrative less speculative, and watch exactly where and why even that cleaner DCF starts misleading even professionals.

For now, sit with this week's lesson. Tesla's stock price and Tesla's fair value are two different things that travel together over long periods and separate dramatically over short ones. Three methods will never give you one answer. They will give you a range and a set of assumptions â and the discipline to defend the assumptions is the edge.
