...
## SpaceX and the IPO That Could Redraw the Map of Capital Markets

If SpaceX comes public in 2026, it will not be just another large tech IPO.

It will be a capital-markets event with the scale to alter how investors think about private-company scarcity, aerospace economics, and Elon Musk's industrial empire.

Bloomberg and The Wall Street Journal reported in early April that SpaceX had confidentially filed for an IPO, with reports pointing to a potential valuation above $1.75 trillion and possibly above $2 trillion — which would make it one of the largest public debuts in history if completed.
