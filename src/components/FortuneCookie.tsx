...
export default function FortuneCookie() {
  ...
  return (
    <div style={{ textAlign: 'center', position: 'relative' }}>
      ...
      {state === 'closed' && (
        <div>
          <button onClick={crack} className="cookie-idle" style={{
            ...
            <Image
              src="/images/fortune-cookie-closed.webp"
      ...
      {/* Cracking — shake then swap to open image */}
      {state === 'cracking' && (
      ...
      {/* Open — cracked cookie + fortune */}
      {state === 'open' && (
        <div className="fortune-reveal">
          <Image
            src="/images/fortune-cookie-open.webp"
            alt="Fortune Cookie cracked open"
            width={240}
            height={240}
            style={{ width: 240, height: 'auto', margin: '0 auto 16px' }}
          />
          <div style={{
      ...
      <style>{`
        ...
        .cookie-shake {
          animation: cookieShake 0.4s ease-in-out 0s 2, cookieFadeOut 0.3s ease-out 0.7s forwards;
        }
        ...
        @keyframes particleBurst {
          ...
          100% { opacity: 0; transform: translate(var(--tx, 0), var(--ty, -50px)) scale(0.2); }
        }
        .crack-particle:nth-child(1)  { --tx: -40px; --ty: -60px; }
        .crack-particle:nth-child(2)  { --tx: 45px; --ty: -55px; }
        .crack-particle:nth-child(3)  { --tx: -25px; --ty: -70px; }
        .crack-particle:nth-child(4)  { --tx: 30px; --ty: -65px; }
        .crack-particle:nth-child(5)  { --tx: -50px; --ty: -35px; }
        .crack-particle:nth-child(6)  { --tx: 55px; --ty: -40px; }
        .crack-particle:nth-child(7)  { --tx: -15px; --ty: -75px; }
        .crack-particle:nth-child(8)  { --tx: 20px; --ty: -70px; }
        .crack-particle:nth-child(9)  { --tx: -35px; --ty: -45px; }
        .crack-particle:nth-child(10) { --tx: 40px; --ty: -50px; }
        .crack-particle:nth-child(11) { --tx: -10px; --ty: -60px; }
        .crack-particle:nth-child(12) { --tx: 15px; --ty: -55px; }
        .crack-particle:nth-child(13) { --tx: -45px; --ty: -25px; }
        .crack-particle:nth-child(14) { --tx: 50px; --ty: -30px; }
        ...
        @media (prefers-reduced-motion: reduce) {
          .cookie-idle, .cookie-shake, .crack-particle, .fortune-reveal {
