      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 24px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 24 }}>
          <div>
            ...
            <h1 style={{ fontFamily: 'var(--serif)', fontSize: 32, fontWeight: 900, color: '#F1F5F9', margin: 0 }}>Fastest Growing</h1>
            <p style={{ fontFamily: 'var(--sans)', fontSize: 14, color: '#64748B', marginTop: 4 }}>Biggest gains across YouTube, TikTok, Instagram & X</p>
          </div>
            ...
            <div key={c.handle} style={{ ...card, display: 'grid', gridTemplateColumns: '36px 1fr auto', gap: 14, padding: '18px 20px', alignItems: 'center' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: 4, marginTop: 8 }}>
                  {c.tags.map(t => <span key={t} style={{ fontSize: 10, fontWeight: 600, padding: '3px 8px', borderRadius: 4, background: '#6B728014', color: '#6B7280', fontFamily: 'var(--mono)' }}>{t}</span>)}
              ...
              <div style={{ textAlign: 'right' }}>
                ...
                <div style={{ fontFamily: 'var(--sans)', fontSize: 10, color: '#475569', marginTop: 2 }}>this week</div>
              </div>
            </div>
          ))}
        </div>
