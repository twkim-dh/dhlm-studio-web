...
// Markdown renderer (same pattern as reports/[slug])
  ...
  if (!a) {
    return (
      <div style={{ background: '#0B0F19', minHeight: '100vh', padding: '120px 24px', textAlign: 'center' }}>
        ...
        <Link href="/research" style={{ color: '#3B82F6', fontSize: 14, marginTop: 16, display: 'inline-block' }}>← All Research</Link>
      </div>
    );
  }
  ...
  return (
    <div style={{ background: '#0B0F19', minHeight: '100vh' }}>
      ...
      <article style={{ maxWidth: 760, margin: '0 auto', padding: '80px 24px' }}>
        <Link href="/research" style={{ fontSize: 12, color: '#64748B' }}>← All Research</Link>
