    ...
    <div style={{ background: '#0B0F19', minHeight: '100vh' }}>
      <article style={{ maxWidth: 680, margin: '0 auto', padding: '80px 24px' }}>
        ...
        {[
          ...
          { h: '3. Financial Disclaimer — No Investment Advice', b: 'Brutal Edge content is educational and informational only. Nothing on this site constitutes financial, investment, legal, or tax advice. We are not registered investment advisors. Market data, stock prices, research reports, and analysis published on this site do NOT constitute personalized investment recommendations. All investment decisions are made at the user\'s own risk. Brutal Edge / DHLM Studio shall not be liable for any losses, damages, or adverse outcomes arising from investment decisions made based on content published on this site. Past performance does not guarantee future results.' },
          ...
          { h: '8. External Links', b: 'This site may contain links to external websites. Brutal Edge / DHLM Studio is not responsible for the content, privacy practices, or accuracy of any external sites. Links to external sites do not constitute endorsement of those sites or their content.' },
          ...
          { h: '10. Limitation of Liability', b: 'DHLM Studio is provided "as is" without warranties of any kind, express or implied. To the maximum extent permitted by applicable law, Brutal Edge / DHLM Studio shall not be liable for any direct, indirect, incidental, consequential, or special damages arising from the use or inability to use this service, including financial losses incurred from investment decisions made based on this content.' },
