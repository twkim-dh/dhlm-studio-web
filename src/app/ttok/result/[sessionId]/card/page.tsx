...
import { getResult, getSession } from '@/lib/ttok-firestore';
import { getQuestionSetById } from '@/data/ttok/questions';
import { getBadge } from '@/lib/ttok-result-calculator';
import type { Result } from '@/types/ttok';
