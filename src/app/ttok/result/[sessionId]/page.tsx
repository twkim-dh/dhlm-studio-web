...
import { getResult, getAnswers, getSession } from '@/lib/ttok-firestore';
import { getQuestionsBySetId, getQuestionSetById } from '@/data/ttok/questions';
import { initKakao, shareResult } from '@/lib/ttok-kakao';
import { getBadge, getInterpretation } from '@/lib/ttok-result-calculator';
import type { Result, Question, Answer } from '@/types/ttok';
