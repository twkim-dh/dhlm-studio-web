    ...
    <div style={{ background: '#0B0F19', minHeight: '100vh' }}>
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '80px 24px' }}>
        ...
        <div style={{ display: 'flex', gap: 6, marginBottom: 20, flexWrap: 'wrap' }}>
          ...
          <Link href="/lottery/mega-millions/stats" style={{ fontSize: 11, color: '#F59E0B', padding: '5px 12px', borderRadius: 20, background: '#111827', border: '1px solid #1E293B' }}>📊 Number Stats</Link>
        </div>
        ...
        <p style={{ fontSize: 9, color: '#334155', textAlign: 'center', marginTop: 16, lineHeight: 1.6 }}>Verify results at megamillions.com. Lottery is for entertainment only. Play responsibly. NOT financial advice. You must be 18+ to play.</p>
      </div>
    </div>
  );
}
