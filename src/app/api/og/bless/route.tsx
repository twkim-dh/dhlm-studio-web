    ...
    (
      <div style={{
        ...
        <div style={{ position: 'absolute', top: 40, left: 60, display: 'flex', alignItems: 'center', gap: 8 }}>
          <span style={{ fontSize: 14, fontWeight: 800, color: '#94A3B8', letterSpacing: 2 }}>DHLM STUDIO</span>
        </div>
        ...
        <div style={{ display: 'flex', gap: 24, alignItems: 'center' }}>
          <div style={{ padding: '12px 24px', borderRadius: 10, background: '#111827', border: '1px solid #1E293B' }}>
            <div style={{ fontSize: 11, color: '#6B7280' }}>DONATED</div>
            <div style={{ fontSize: 24, fontWeight: 900, color: '#D4A843' }}>{amount}</div>
          </div>
          <div style={{ padding: '12px 24px', borderRadius: 10, background: '#111827', border: '1px solid #1E293B' }}>
            <div style={{ fontSize: 11, color: '#6B7280' }}>BY</div>
            <div style={{ fontSize: 20, fontWeight: 700, color: '#E2E8F0' }}>{name}</div>
          </div>
        </div>

        {/* Charity note */}
        <div style={{ position: 'absolute', bottom: 40, fontSize: 13, color: '#475569' }}>
